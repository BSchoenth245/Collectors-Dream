// === ELECTRON MAIN PROCESS WITH MONGODB SETUP ===
...
function createSetupWindow() {
    ...
    setupWindow.loadFile('mongodb-setup.html');
...
// Handle MongoDB setup completion
ipcMain.on('mongodb-setup-complete', async () => {
    ...
    if (mongoInstalled) {
        ...
        dialog.showErrorBox(
            'MongoDB Not Found',
            'MongoDB was not detected on your system. Please install MongoDB and try again.'
        );
    }
});
